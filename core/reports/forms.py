...
from core.pos.models import Product, Receipts
...
class ReportForm(forms.Form):
    ...
    receipts = forms.ModelChoiceField(widget=forms.Select(attrs={
        'class': 'form-control select2',
        'style': 'width: 100%;'
    }), queryset=Receipts.objects.all().order_by('id'), label='Tipo de Comprobante')
