...
var sale = {
    ...
    calculateInvoice: function () {
        ...
        this.details.subtotal_0 = this.details.products.filter(value => !value.with_tax).reduce((a, b) => a + (b.total || 0), 0);
        this.details.subtotal_12 = this.details.products.filter(value => value.with_tax).reduce((a, b) => a + (b.total || 0), 0);
        ...
        this.details.total_iva = this.details.products.filter(value => value.with_tax).reduce((a, b) => a + (b.total_iva || 0), 0);
