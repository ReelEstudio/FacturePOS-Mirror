        ...
        tblPurchase = $('#data').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    class: 'text-center',
                    render: function (data, type, row) {
                        if (row.payment_method.id === 'credito') {
                            return '<span class="badge badge-warning badge-pill">' + row.payment_method.name + '</span>';
                        }
                        return '<span class="badge badge-success badge-pill">' + row.payment_method.name + '</span>';
                    }
                },
                {
                    targets: [-2],
