...
var company = {
    loadCertificate: function () {
        ...
        parameters.append('action', 'load_certificate');
        parameters.append('certificate', input_electronic_signature[0].files[0]);
        parameters.append('electronic_signature_key', $('input[name="electronic_signature_key"]').val());
        $.ajax({
            url: pathname,
            data: parameters,
            type: 'POST',
...
$(function () {
    ...
    input_electronic_signature
        .wrap("<div class='input-group mb-3'></div>")
        .after('<div class="input-group-append"><button class="btn btn-secondary btn-flat btnLoadCertificate" type="button" disabled><i class="fa-solid fa-file-circle-check"></i> Obtener información</button></div>');
