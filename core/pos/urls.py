...
from core.pos.views.receipt_states.views import *
from core.pos.views.receipts.views import *
...
urlpatterns = [
    ...
    # receipts
    path('receipts/', ReceiptsListView.as_view(), name='receipts_list'),
    path('receipts/add/', ReceiptsCreateView.as_view(), name='receipts_create'),
    path('receipts/update/<int:pk>/', ReceiptsUpdateView.as_view(), name='receipts_update'),
    path('receipts/delete/<int:pk>/', ReceiptsDeleteView.as_view(), name='receipts_delete'),
    # category
    ...
    # receipt_states
    path('receipt/states/', ReceiptStatesListView.as_view(), name='receipt_states_list'),
    path('receipt/states/delete/<int:pk>/', ReceiptStatesDeleteView.as_view(), name='receipt_states_delete'),
]
